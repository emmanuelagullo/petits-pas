...
indique où commencer, qui peut agir et ce que l’application doit produire.
...
- ajouter un commentaire ou une photographie ;
- modifier, masquer, retirer ou restaurer une trace ;
...
- corriger une identité ou un niveau ;
- déplacer, retirer, archiver ou réactiver un élève ;
...
périodes, les cumuls et les refus significatifs.
...
référence éditoriale du guide. Il évite de documenter comme accessible une
fonction qui n’existe encore que dans le modèle ou dans un service interne.
