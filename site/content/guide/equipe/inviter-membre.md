...
3. Vérifier le message : il indique si le courriel a été envoyé ou si son envoi
   a échoué.
4. Si nécessaire, copier le **lien de secours** affiché à cet instant et le
...
valable sept jours et son lien n’est utilisable qu’une fois. Le courriel explique
comment créer un compte ou rattacher un compte existant.
...
- Un échec du courriel n’annule pas l’invitation : le lien de secours reste
  utilisable.
